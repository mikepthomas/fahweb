...
<div class="container marketing">
    <div class="row">
        ...
        <div id="whatIsProteinFolding" class="modal hide fade" role="dialog" aria-hidden="true">
        ...
        <div id="whyDoesItMatter" class="modal hide fade">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div id="howCanIHelp" class="modal hide fade">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div id="startFoldingNow" class="modal hide fade">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div id="getHelp" class="modal hide fade">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        ...
        <div id="joinATeam" class="modal hide fade">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
